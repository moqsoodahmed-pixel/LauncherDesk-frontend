...
/* ─── WhatsApp pre-filled message (homepage bot trigger) ─────────────── */
...
export default function Footer() {
  ...
  return (
    <footer style={{ background: '#0D1B2E', color: '#dde8f4' }}>
      ...
      <div className="wrap" style={{ padding: '56px 24px 0' }}>
          ...
          {NAV_COLS.map(col => (
            <div key={col.title}>
              ...
              {col.links.map(([label, href]) => (
                <a key={href} href={href} style={{ display: 'block', fontSize: 13.5, color: '#c8d8e8', marginBottom: 10, textDecoration: 'none', transition: 'color .15s' }}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 24, margin: '40px 0 0', padding: '28px 0', borderTop: '1px solid rgba(255,255,255,.07)', borderBottom: '1px solid rgba(255,255,255,.07)' }}>
          ...
          <div>
            ...
            <a href="tel:+918548854859" style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, color: '#dde8f4', textDecoration: 'none', marginBottom: 10, transition: 'color .15s' }}
            ...
            <a href="mailto:contact@launcherdesk.com" style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13.5, color: '#dde8f4', textDecoration: 'none', marginBottom: 16, transition: 'color .15s' }}
              onMouseEnter={e => e.currentTarget.style.color = '#fff'} onMouseLeave={e => e.currentTarget.style.color = '#dde8f4'}>
