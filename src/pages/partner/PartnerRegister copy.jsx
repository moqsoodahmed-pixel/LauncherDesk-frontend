...
export default function PartnerRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Auto-login the partner after successful registration
          ...
          {done ? (
            <div className="pr-form-card">
              <div className="pr-success">
                ...
                <p>
                  Thank you for applying to partner with LauncherDesk. Your account has been created — you can now log in to your <strong>Partner Dashboard</strong> to track leads and check your application status.<br/><br/>
                  Our team will review your application within <strong>2–3 business days</strong>. Redirecting you to your dashboard…
                </p>
                <div className="pr-success-cta">
                  <a href="/partner/dashboard" style={{display:'inline-flex',alignItems:'center',gap:8,padding:'0 22px',height:46,borderRadius:9,background:'var(--blue)',color:'#fff',fontWeight:700,fontSize:14,textDecoration:'none'}}>Go to Dashboard →</a>
            ...
            <div className="pr-form-card">
              ...
              <form className="pr-form" onSubmit={handleSubmit}>
                ...
                {/* Account password */}
                <div className="pr-section-head">Create Your Login Password</div>
                <div style={{background:'#EFF6FF',border:'1px solid #BFDBFE',borderRadius:9,padding:'10px 14px',fontSize:13,color:'#1E40AF',marginBottom:4}}>
                  🔐 This password will be used to log into your Partner Dashboard after registration.
                </div>
                <div className="pr-row">
                  <div className="pr-field">
                    <label className="pr-label">Password * (min. 6 characters)</label>
                    <input className="pr-input" required type="password" placeholder="Create a strong password" value={form.password} onChange={e=>set('password',e.target.value)}/>
                  </div>
                  <div className="pr-field">
                    <label className="pr-label">Confirm Password *</label>
                    <input className="pr-input" required type="password" placeholder="Re-enter your password" value={form.confirmPassword} onChange={e=>set('confirmPassword',e.target.value)}/>
                  </div>
                </div>
