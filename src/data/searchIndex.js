...
export const SEARCH_ITEMS = [
  ...
  { id: 'contact-page', title: 'Contact Us & Book a Consultation', category: 'Company', badge: 'Support', desc: 'Reach our Bangalore headquarters, talk to our expert or schedule a direct consultation.', path: '/company/contact', keywords: ['contact', 'phone', 'email', 'support', 'bangalore office', 'consultation', 'whatsapp'], icon: 'phone' },
